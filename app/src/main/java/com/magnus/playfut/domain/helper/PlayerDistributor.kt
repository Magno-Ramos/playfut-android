...
//    private fun createEmptyTeams(teamCount: Int): MutableList<Schema> {
...
//                                Replacement(substitute, improvisedGK)
//                            )
//                        }
//                    }
//                }
...
//
//                suggestions.add(Replacement(playerIn = inId, playerOut = outId))
